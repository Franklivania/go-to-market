...
export default function CompleteOnboarding() {
  ...
  const options =
    openType === "country" ? countryOptions : country ? getStatesForCountry(country) : [];
  ...
  return (
    <AuthLayout style={{ alignItems: "flex-start" }}>
      <Typography variant="h2" fontWeight={400} style={{ marginBottom: 32 }}>
        Complete Onboarding
      </Typography>
      ...
      <Typography variant="body2" style={{ alignSelf: "flex-end", marginTop: 48 }}>
        ...
        <Typography color={colors.orange[600]} onPress={() => router.push("/(user)/dashboard")}>
          Skip
        </Typography>
      </Typography>
